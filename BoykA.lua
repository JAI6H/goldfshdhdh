...
io.popen("cd library && wget https://raw.githubusercontent.com/amrjava/gold/main/library/redis.lua") 
...
os.execute('wget https://raw.githubusercontent.com/amrjava/gold/main/BoykA.lua')
...
if text == 'يا بوت' or text == 'بوت' or text == 'بوت جولد' then
local Text = [[
اسمي  ]].. Name_Bot..[[ يحبيبي.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'ᴅᴇᴠᴇʟᴏᴘᴇʀ.', url = "https://t.me/"..UserName_Dev}
},
{
{text = 'اضف البوت لمجموعتك☑️', url="https://t.me/"..User_Bot.."?startgroup=new"}
},
}
local msg_id = msg.id_/2097152/0.5
